        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              ...
              <span>les agents Commerciales</span>
              </a>
            <ul class="sub">
             
              <li><a href="form">ajouter Agent</a></li>
              <li><a href="tabel_agent">Consulter les Agents</a></li>
            </ul>
          </li>
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              <i class="fa fa-book"></i>
              <span>les Palliers de Motivation</span>
              </a>
            <ul class="sub">
             
              <li><a href="form_pallier">ajouter Pallier</a></li>
              <li><a href="tabel_pallier">Consulter les Pallier</a></li>
            </ul>
          </li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a href="form_challeng">ajouter Challenge</a></li>
              <li><a href="tabel_challeng">Consulter les Challenges</a></li>
            </ul>
          </li>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="formation">ajouter Formation</a></li>
              <li><a href="tabel_formation">Consulter les formations</a></li>
            </ul>
          </li>
          ...
          <li >
            <a  href="activite">
              <i class="fa fa-dashboard"></i>
              <span>Les activités des Agents</span>
              </a>
          </li>
