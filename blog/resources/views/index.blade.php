      ...
      <section class="wrapper">
        <div class="row">
                ...
                <div class="message-p pn">
                  ...
                  <div class="row">
                    <div class="col-md-3 centered hidden-sm hidden-xs">
                      <img src="{{asset('img/ui-danro.jpg')}}" class="img-circle" width="65">
                    </div>
                    <div class="col-md-9">
                      <p>
            ...
            <div class="row">
              <div class="col-lg-4 col-md-4 col-sm-4 mb">
                <div class="product-panel-2 pn">
                  ...
                  <img src="{{asset('img/product.jpg')}}" width="200" alt="">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 mb">
                <div class="content-panel pn">
                  <div id="profile-02">
                    <div class="user">
                      <img src="{{asset('img/friends/fr-06.jpg')}}" class="img-circle" width="80">
                      <h4>DJ SHERMAN</h4>
                    </div>
                  </div>
          ...
          <div class="col-lg-3 ds">
            ...
            <div class="desc">
              <div class="thumb">
                <img class="img-circle" src="{{asset('img/ui-sherman.jpg')}}" width="35px" height="35px" align="">
              </div>
              <div class="details">
                <p>
