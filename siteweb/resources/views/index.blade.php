...
<html lang="en">
  <head>
    <title>GetUp &mdash;</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    
    
    <link href="https://fonts.Fgoogleapis.com/css?family=Nunito:300,400,700" rel="stylesheet">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-md-3 col-xl-4  d-block">
            <h1 class="mb-0 site-logo"><a href="index.html" class="text-black h2 mb-0">GetUp<span class="text-primary">.</span> </a></h1>
          </div>
          ...
          <div class="col-12 col-md-9 col-xl-8 main-menu">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block ml-0 pl-0">
                ...
                <li><a href="#testimonials-section" class="nav-link">Offres</a></li>
                <li><a href="#contact-section" class="nav-link">Contact</a></li>
                <li></li>
                <button type="button" class="bttn-white price-footer"><a href="/inscrire">S'inscrire</a></button>
          ...
          <div class="col-md-12" style="position: relative;" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="row mb-4" data-aos="fade-up" data-aos-delay="200">
              <div class="col-lg-6 mr-auto">
                <h1>Rendre Votre Entreprise Plus Rentable</h1>
      ...
      <div class="container">
        <div class="row mb-5 justify-content-center text-center"  data-aos="fade-up">
          <div class="col-7 text-center  mb-5">
            <h2 class="section-title">GetUp Features</h2>
<!--          <p class="lead">Lorem ipsum dolor sit amet, consectetur
               adipisicing elit. Fuga quos quaerat sapiente nam, id vero.</p>    --> 
        ...
        <div class="row align-items-stretch">
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
            ...
            <div class="unit-4 d-block">
              ...
              <div>
                ...
                <p>Un version d'essai gratuite est disponible pour vous pendant deux semaines  .</p>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="unit-4 d-block">
              ...
              <div>
                <h3>100% Satisfait</h3>
                <p>Notre premier objectif est de garantir votre satisfaction à légard de nos services.</p>
                <!--  <p><a href="#">Learn More</a></p> -->
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="unit-4 d-block">
              ...
              <div>
                <h3>Interface ergonomique et facile</h3>
                <p>Nous essayons de vous garantir une interface ergonomique et facile à utiliser.</p>
                <!--  <p><a href="#">Learn More</a></p> -->
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="unit-4 d-block">
              ...
              <div>
                ...
                <p>La sécurité de vos données est une de nos propriétés.</p>
              <!--  <p><a href="#">Learn More</a></p> -->
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up"  data-aos-delay="200">
            <div class="unit-4 d-block">
              ...
              <div>
                ...
                <p>Faite votre achat en ligne avec des modes de paiement faciles et fiables .</p>
               <!-- <p><a href="#">Learn More</a></p>  --> 
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4" data-aos="fade-up">
            <div class="unit-4 d-block">
              ...
              <div>
                ...
                <p>Vous pouvez facilement mettre à jour votre plateforme gratuitement.</p>
              <!--  <p><a href="#">Learn More</a></p> -->
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row mb-5 site-section">
          ...
          <div class="col-lg-5 pl-lg-5 ml-auto mt-md-5">
            <h2 class="text-black">Un Terrain de Challenges</h2>
            <p class="mb-4">Avec notre plateforme vous pouvez motiver vos commerciaux avec des challenges afin de créer une atmosphère compétitive entre eux.</p>
   ...
   <!--       <div class="author-box" data-aos="fade-left">
        ...
        <div class="mt-5 row mb-5 site-section ">
          ...
          <div class="col-lg-5 pr-lg-5 mr-auto mt-5 order-2 order-lg-1">
            <h2 class="text-black">Unité de Formation</h2>
            <p class="mb-4">Vous avez la main de diffuser des formations en ligne à disposition de vos équipes .</p>
      ...
      <div class="container">
        ...
        <div class="row mb-5">
          ...
          <div class="col-lg-5 ml-auto pl-lg-5">
            <h2 class="text-black mb-4 h3 font-weight-bold">Notre Mission</h2>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-4">
                    <div class="price-box">
                        ...
                        <div class="price-rate">
                            <sup>DT</sup> <span class="rate">0</span> <small>/mois</small>
                        </div>
                        <div class="price-footer">
                            <a href="/inscrire" class="bttn-white">acheter</a>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="price-box">
                        ...
                        <div class="price-rate">
                            <sup>DT</sup> <span class="rate">49</span> <small>/mois</small>
                        </div>
                        <div class="price-footer">
                            <a href="/inscrire" class="bttn-white">acheter</a>
                        </div>
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="price-box">
                        ...
                        <div class="price-rate">
                            <sup>DT</sup> <span class="rate">99</span> <small>/mois</small>
                        </div>
                        <div class="price-footer">
                            <a href="/inscrire" class="bttn-white">acheter</a>
                        </div>
    ...
    <div class="site-section bg-image2 overlay" id="contact-section" style="background-image: url('images/option.jpg');">
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            <h2 class="section-title mb-3 text-white">Contact </h2>
          </div>
        </div>
        <div class="row justify-content-center">
          <div class="col-lg-7 mb-5">
            ...
            <form action="submit" method="POST" class="p-5 bg-white">
              @
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="message" id="message" cols="30" rows="7" class="form-control rounded-0" ></textarea>
                </div>
              </div>

              <div class="row form-group">
                <div class="col-md-12">
                  <input type="submit" value="Envoyer Message" class="btn btn-primary mr-2 mb-2">
                </div>
              </div>
